...
export const phases = [
  ...
  { id: '17', type: 'CustomNode',  data: { category: 'research', label: 'Online', img: ChartImg1 }, position: { y: 350, x: 1050 }, ...nodeDefaults, style: { backgroundColor: nodeColor({ category: 'research' }), color: 'white', border:'none' }  }, 
  ...
  { id: '20', type: 'CustomNode',  data: { category: 'research', label: 'Health', img: ChartImg4 }, position: { y: 790, x: 1050 }, ...nodeDefaults, style: { backgroundColor: nodeColor({ category: 'research' }), color: 'white', border:'none' }  },

  {id: '22',
  position: { y: 550, x: 1350 },
  type: 'custom',
  data: {},
  style: {
    border: '1px solid #ccc',
